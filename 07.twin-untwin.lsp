...
;;    lst - a list of items
;; Assumptions:
;;    1.* lst is not a nested list

;; untwin function:  takes out any pairs in a list
;; Arguments:
;;    lst - a list of items
;; Assumptions:
;;    1. a "pair" is an adjacent identical pair of items.
;;    2. lst is not a nested list
;;    3. no more than 2 pairs will be adjacent
...
;; -------------------------------------------------------------------------------------------------
;; empty list                 ()                      ()
;; singleton                  (momhesmimicingme)      (momhesmimicingme)
