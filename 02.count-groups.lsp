...
;; count_groups function: Given a list, count the number of groups (a group is two or more identical
;; adjecent items).
;; Parameters:
...
;; eat-group function: Given a string and a list, return the part of the list after all dupllicates
;; of the string.
;; Parameters:
;;    name - a string
;;    lst - a list of items
;; Assumptions:
;;    1. The list contains no nested lists.
;;    2. The string to filter past is not empty.
;;    3. The list to look in is not empty.
;;    4. The name to eat is the first item in the list.
;;    5. The group is consecutive.
